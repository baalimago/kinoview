...
const defaultPrompt = `You are a media classifier. Your job is to fill in the metadata for a given piece of media.
...
Information about the media to classify: %v`
...
func buildChat(i model.Item, t0 time.Time) models.Chat {
	return models.Chat{
		...
		Messages: []models.Message{
			{
				Role:    "user",
				Content: fmt.Sprintf(defaultPrompt, i),
			},
		},
	}
}
